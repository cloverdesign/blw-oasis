...
export const Hero = () => {
    return (
        <section className="flex flex-col items-center justify-center gap-10 lg:gap-20  px-4 lg:px-10">
            <Reveal as="h1" amount={0} className="text-5xl lg:text-8xl text-center capitalize">Who We Are.</Reveal>

            <Reveal amount={0} delay={0.15} className="lg:w-[60%]">
