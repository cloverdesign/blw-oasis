...
export function CampusCard({ location }: { location: Location }) {
    ...
    return (
        <div
            className="bg-primary rounded-2xl relative overflow-hidden min-h-[364px] flex flex-col justify-end"
            style={
                imageUrl
                    ? {
        ...
        >
            ...
            <div className="bg-background text-foreground p-4 rounded-xl m-3">
